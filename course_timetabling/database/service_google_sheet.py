...
def get_manual_allocation():
    ...
    manual_allocation = df.filter(["Nome curto professor", "Código único turma", "Código disciplina", "Qtd de créditos", "Tipo disciplina", "Dia da semana", "Horário"])
    manual_allocation.rename(columns={"Nome curto professor": "professor", "Código único turma": "course_class_id", "Código disciplina": "course_id", "Qtd de créditos": "credits", "Tipo disciplina": "course_type", "Dia da semana": "day", "Horário": "time"}, inplace=True)
