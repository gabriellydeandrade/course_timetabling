...
DUMMY_COEFFICIENT = config("DUMMY_COEFFICIENT", default=0.0001, cast=float)
DEFAULT_COEFFICIENT = config("DEFAULT_COEFFICIENT", default=100, cast=float)
SERVICE_COURSE_COEFFICIENT_SP = config("SERVICE_COURSE_COEFFICIENT_SP", default=10, cast=float)
SERVICE_COURSE_COEFFICIENT_PP = config("SERVICE_COURSE_COEFFICIENT_PP", default=1, cast=float)
ZERO_COEFFICIENT = config("ZERO_COEFFICIENT", default=0, cast=int)
WEIGHT_FACTOR_PP = config("WEIGHT_FACTOR_PP", default=1000, cast=float)
